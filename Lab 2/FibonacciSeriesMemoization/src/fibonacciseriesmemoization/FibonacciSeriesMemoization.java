package fibonacciseriesmemoization;
...
public class FibonacciSeriesMemoization {
    ...
    public static void main(String[] args) {
        ...
        FibonacciSeriesMemoization fibonacciAlgorithm = 
                new FibonacciSeriesMemoization();
        System.out.println("Fibonacci value for n=7:  "
                +fibonacciAlgorithm.fibonacciMemoize(7));
